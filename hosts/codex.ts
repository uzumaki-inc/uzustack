...
const codex: HostConfig = {
  ...
  globalRoot: '.codex/skills/uzustack',
  localSkillRoot: '.agents/skills/uzustack',
  hostSubdir: '.agents',
  usesEnvVars: true,
  ...
  pathRewrites: [
    ...
    { from: '.claude/skills/uzustack', to: '.agents/skills/uzustack' },
    { from: '.claude/skills/review', to: '.agents/skills/uzustack/review' },
